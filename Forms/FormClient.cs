...
namespace Projet_Synthèse_Final
{
    public partial class FormClient : Form
    {
        ...
        public void AfficherClientListview(Vehicule v)
        {
            ...
            arr[2] = v.Prenom;
            arr[3] = v.Telephone;
            arr[4] = v.Date.ToLongDateString().ToString();
            arr[5] = v.Jour.ToString();
            arr[6] = v.Modele;
            arr[7] = v.Prix.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {                              
                ...
                Vehicule cli = new Vehicule(textBox_Permis.Text, textBox_Nom.Text, textBox_Prenom.Text, textBox_Telephone.Text,
                    dateTimePicker1.Value.Date, int.Parse(textBox_Jour.Text), comboBox_Modele.Text, int.Parse(textBox_Prix.Text));
        ...
        private void button_Modifier_Click(object sender, EventArgs e)
        {
            ...
            if (VerifierTous()) // Si tous les champs entrés sont valides
            {
                ...
                {
                    listView1.Items.Add(new ListViewItem(new String[] { c.Permis.ToString(), c.Nom, c.Prenom, c.Telephone, c.Date.ToShortDateString(),
                    c.Jour.ToString(), c.Modele , c.Prix.ToString()}));
                }
